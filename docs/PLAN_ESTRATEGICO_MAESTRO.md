...
| **INT-AUD** | Integridad transaccional — auditoría (STK/AGD/PAY/BON/TRV) + remediación en 7 hitos (H0-H7) | 🟡 H0 cerrado | 15% | H0 ✅: deployment `ramgos-audit` (`oceanic-goose-862`), fixtures internas, 4 tests de concurrencia reales sin skip, job `audit-concurrency` en CI (faltan los 4 secrets en GitHub). STK-03 y AGD-02 en rojo por diseño (5/5 sobreventa), BON-01 y PAY-01 verdes. Siguiente: H1 (seeds públicos) y H2 (bono en refund) con Sonnet; H3 reserva atómica; H4 conectar eventos (decidido); H5 agenda. Plan: `~/.claude/plans/ac-est-el-prompt-adaptive-zephyr.md` | 2026-09-04 |
