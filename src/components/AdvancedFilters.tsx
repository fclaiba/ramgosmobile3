...
const CATEGORIES = [
    ...
    'Salud', 'Belleza', 'Automotriz', 'Mascotas',
    'Gastronomía', 'Libros', 'Eventos', 'Bonos'
];
...
const styles = StyleSheet.create({
    ...
    modalCard: { backgroundColor: 'white', borderTopLeftRadius: 24, borderTopRightRadius: 24, height: '85%', shadowColor: '#000', shadowOpacity: 0.25, shadowRadius: 10, elevation: 20 },
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 24, paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
    ...
    sectionTitle: { fontSize: 13, fontWeight: 'bold', color: '#111827', marginBottom: 16, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    priceInput: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, paddingHorizontal: 16, height: 48 },
    currency: { color: '#9CA3AF', marginRight: 8, fontSize: 15 },
    input: { flex: 1, fontSize: 15, color: '#111827', fontWeight: '600' },
    priceDivider: { width: 12, height: 2, backgroundColor: '#E5E7EB' },

    ratingChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', gap: 6 },
    ratingChipActive: { backgroundColor: '#7C3AED', borderColor: '#7C3AED' },
    ratingText: { fontSize: 14, fontWeight: '600', color: '#4B5563' },
    ratingTextActive: { color: '#fff' },

    footer: { flexDirection: 'row', padding: 24, borderTopWidth: 1, borderTopColor: '#F3F4F6', gap: 16 },
    clearBtn: { paddingVertical: 14, paddingHorizontal: 24, borderRadius: 16, borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center' },
    clearBtnText: { color: '#4B5563', fontWeight: '600', fontSize: 15 },
    applyBtn: { flex: 1, backgroundColor: '#111827', borderRadius: 16, alignItems: 'center', justifyContent: 'center', paddingVertical: 14, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
