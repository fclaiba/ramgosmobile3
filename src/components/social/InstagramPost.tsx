...
import { View, Image, StyleSheet, TouchableOpacity, Dimensions, Modal, Text } from 'react-native';
...
export const InstagramPost = ({ post }: { post: IGPostType }) => {
    ...
    return (
        <>
            ...
            {/* Detail Modal */}
            <Modal visible={showDetail} animationType="fade" onRequestClose={() => setShowDetail(false)}>
