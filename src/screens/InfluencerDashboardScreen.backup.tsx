...
function InfluencerDashboardScreen({ isTabMode, onMenuPress }: any) {
            ...
            >
                ...
                <Card style={[styles.codeCard, { width: '100%', maxWidth: metricsLayout.containerWidth, alignSelf: 'center' }]}>
                    <View style={{ marginBottom: 16 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                            ...
                            <Text style={{ color: '#fff', fontWeight: 'bold' }}>Tu Enlace de Afiliado</Text>
                        </View>
                        <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 12 }}>Cópialo y pégalo en tu Link in Bio</Text>
                    </View>
                    <View style={styles.codeBox}>
                        ...
                        <View style={{ flexDirection: 'row', gap: 8 }}>
                            ...
                            <TouchableOpacity onPress={handleShare} style={[styles.copyBtn, { backgroundColor: '#4f46e5' }]}>
                ...
                <Card style={[styles.transferCard, { width: '100%', maxWidth: metricsLayout.containerWidth, alignSelf: 'center' }]}>
                    <View style={styles.transferHeader}>
                        ...
                        <View style={{ flex: 1 }}>
                            <Text style={styles.transferTitle}>Generador de Bonos</Text>
                            <Text style={styles.transferSubtitle}>Crea cupones de descuento exclusivos para tus seguidores y conviértelos en clientes.</Text>
                        </View>
                        <Button size="sm" style={styles.transferButton} onPress={() => setModalVisible(true)}>
                            <Text style={{ color: '#fff', fontWeight: '600' }}>Crear bono</Text>
                        </Button>
                    </View>
                    <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
                        <Text style={{ fontSize: 13, color: isDark ? '#9CA3AF' : '#6B7280' }}>
                            Tus seguidores podrán aplicarlo en la tienda usando tu código afiliado.
                        </Text>
                    </View>
                </Card>
                ...
                <View style={[styles.centeredView, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 16 }]}>
                    <View style={[styles.modalView, { maxHeight: windowHeight * 0.86 }]}>
                        <View style={styles.modalHeaderRow}>
                            <View style={{ flex: 1, minWidth: 0 }}>
                                <Text style={styles.modalTitle}>Crear Bono de Descuento</Text>
                                <Text style={styles.modalText}>Tus seguidores podrán reclamar este bono en la plataforma.</Text>
                            </View>
                            <TouchableOpacity
                        ...
                        >
                            <View style={styles.formGroup}>
                                <Text style={styles.modalLabel}>Título del bono</Text>
                                <TextInput
                                    style={styles.input}
                            ...
                            <View style={styles.formGroup}>
                                <Text style={styles.modalLabel}>Porcentaje de descuento (%)</Text>
                        ...
                        <View style={styles.modalFooter}>
                            <View style={[styles.modalActionsRow, windowWidth < 420 && { flexDirection: 'column' }]}>
                                ...
                                <Button onPress={handleCreateBono} style={[windowWidth < 420 ? { width: '100%' } : { flex: 1 }, { backgroundColor: '#4f46e5' }]}>
...
const HOC_KeyboardAvoidingView_InfluencerDashboardScreen = (props: any) => (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <InfluencerDashboardScreen {...props} />
    </KeyboardAvoidingView>
);
export default HOC_KeyboardAvoidingView_InfluencerDashboardScreen;
